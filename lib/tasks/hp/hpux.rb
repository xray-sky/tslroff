collectionNamespace 'HPUX' do
  ...
  manualNamespace '6.00', # TODO fix file dates (in 2021)
  ...
  manualNamespace '8.07',
    vendor_class: HPUX::V8_07,
    odir: 'HP/HPUX/8.07',
    sources: %w[usr/man/man*]
  manualNamespace '9.00',
    vendor_class: HPUX::V9_00,
    odir: 'HP/HPUX/9.00',
    sources: %w[man/man*]
  manualNamespace '9.03',
