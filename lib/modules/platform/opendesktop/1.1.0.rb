...
class OpenDesktop:V1_1_0
  class Manual < ::Manual
    ...
    ZEXTRA = %w[
      ...
      wtinit.ADM.z	xtd.ADM.z	xts.ADM.z

      4014.C.z	assign.C.z	at.C.z	auths.C.z	awk.C.z	bfs.C.z	cal.C.z	calendar.C.z
      chgrp.C.z	cmp.C.z	col.C.z	compress.C.z	cp.C.z	crypt.C.z	csplit.C.z	ct.C.z
      cu.C.z	date.C.z	dc.C.z	df.C.z	diff.C.z	diff3.C.z
      ...
      write.C.z	x286emul.C.z	xtod.C.z

      86rel.F.z	Intro.F.z	ar.F.z	archive.F.z	cpio.F.z	default.F.z	devices.F.z
      dialers.F.z	dir.F.z	dirent.F.z	filesys.F.z	gps.F.z	inode.F.z	issue.F.z
      langif.F.z	ldfcn.F.z	logs.F.z	maildel.F.z	maxuus.F.z	maxuux.F.z
      mdevice.F.z	mtune.F.z	mvdevice.F.z	null.F.z	passwd.F.z
      ...
      timod.M.z	trchan.M.z	tty.M.z	tz.M.z

      bitmap.X.z	xman.X.z	xterm.X.z	X.X.z	mwm.X.z	xdm.X.z	xedit.X.z
      ...
      mkdev.ADM.z	mmdf.ADM.z	mount.ADM.z	proto.ADM.z	reduce.ADM.z	sag.ADM.z
      sar.ADM.z	setmnt.ADM.z	shtdwn.ADM.z	sync.ADM.z	tcbck.ADM.z	uadmin.ADM.z
      uucico.ADM.z	uulist.ADM.z	uutry.ADM.z	wall.ADM.z	xtt.ADM.z
      ...
      a.out.F.z	authcap.F.z	clock.F.z
      core.F.z	filehdr.F.z	filesyst.F.z	fspec.F.z	group.F.z	hs.F.z	inittab.F.z
      limits.F.z	linenum.F.z	mapchan.F.z	mem.F.z	mfsys.F.z	micnet.F.z
      mnttab.F.z	nl_type.F.z	permiss.F.z	plot.F.z	pnch.F.z	poll.F.z	reloc.F.z
      sccsfile.F.z	scnhdr.F.z	scr_dump.F.z	sdevice.F.z	tables.F.z	termcap.F.z
      terminfo.F.z	top.F.z	types.F.z	utmp.F.z	x.out.F.z	xbackup.F.z

      Intro.HW.z
      boot.HW.z	cdrom.HW.z	cmos.HW.z	hd.HW.z	machine.HW.z	mouse.HW.z	ramdisk.HW.z
      rtc.HW.z	screen.HW.z	tape.HW.z	xt.HW.z	ascii.M.z

      cvtomf.M.z	fcntl.M.z
      isverify.M.z	jagent.M.z	login.M.z	mapchan.M.z	messages.M.z	mestbl.M.z	numtbl.M.z
      prof.M.z	profile.M.z	rmb.M.z	streamio.M.z	sxt.M.z	terminfo.M.z	timtbl.M.z
