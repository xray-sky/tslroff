...
collection_namespace 'unbundled' do
  ...
  manual_namespace 'ANSI-C_A10.11/S700', # TODO there's some Japanese language manual pages in here, too
  ...
  manual_namespace 'C++_A.03.20/S300', # REVIEW has extra man macros in usr/CC/man/SC/manmacros
                  vendor_class: HPUX::V9_05,
  ...
  manual_namespace 'Instrument-Control-Lib_G.03.00',
                  vendor_class: HPUX::V9_05,
  ...
  manual_namespace 'Network-Peripheral-Interface_A.02.00',
                  vendor_class: HPUX::V8_05,
  ...
  manual_namespace 'PersonalVisualizer_2.11/S700',
                  vendor_class: HPUX::V8_05,
