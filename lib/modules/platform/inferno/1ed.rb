...
class Inferno::FirstEd
  class HTML < ::Inferno::HTML
    ...
    def source_init
      ...
      when 'md_pref4.htm' then @source.patch_line( 77, %r{^<em>}, '</a>')
      when 'md_sys6.htm'  then @source.patch_line( 28, %r{^<em>}, '</a>')
      when 'md_sys7.htm'  then @source.patch_line(163, %r{^<em>}, '</a>')
      when 'md_sys8.htm'  then @source.patch_line( 23, %r{^<em>}, '</a>')
      when 'md_sys10.htm' then @source.patch_line( 85, %r{^<em>}, '</a>')
      when 'md_sys11.htm' then @source.patch_line(219, %r{^<em>}, '</a>')
      when 'md_sys15.htm' then @source.patch_line( 21, %r{^<em>}, '</a>')
      when 'proto.htm'    then @source.patch_line(391, %r{^<em>}, '</a>')
