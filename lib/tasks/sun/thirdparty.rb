collectionNamespace 'thirdparty' do
  ...
  manualNamespace 'ArborText/Publisher_3.1.1',
  ...
  manualNamespace 'ArborText/Adept_Publisher_5.0.2',
  ...
  manualNamespace 'Centerline/TestCenter_1.0.2_beta1.0',
    vendor_class: SunOS::V5_1,
  ...
  manualNamespace 'Centerline/ViewCenter_2.5.0',
  ...
  manualNamespace 'HP/NPI_A.02.00',
    vendor_class: SunOS::V4_1,
  ...
  manualNamespace 'IXI/Motif_1.1_X11R4',
  ...
  manualNamespace 'IXI/Motif_Developer_Pack_1.2.2a',
    vendor_class: SunOS::V4_0,
  ...
  manualNamespace 'Lucid/Energize_2.1',
    vendor_class: SunOS::V4_0,
  ...
  manualNamespace 'Pixar/High_Speed_Interface_1.1',
  ...
  manualNamespace 'Transarc/AFS_3.2',
    vendor_class: SunOS::V4_1_4,
