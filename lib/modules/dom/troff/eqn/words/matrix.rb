class Troff
  module Eqn
    ...
    def eqn_bracket(parse_tree)
      ...
      Troff.webdriver.browser.get selenium.to_html
      height = begin
                 to_em(to_u(Troff.webdriver.browser.find_element(id: 'selenium').size.height.tap { |n| warn "selenium measured bracket inside height #{n.inspect}px" }.to_s, default_unit: 'px'))
