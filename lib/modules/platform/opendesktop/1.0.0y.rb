...
class OpenDesktop::V1_0_0y
  ...
  class Manual < ::Manual
    ...
    ZEXTRA = %w[
      ...
      tplot.ADM.z	umount.ADM.z	uuxqt.ADM.z	wtinit.ADM.z	xtd.ADM.z

      4014.C.z	assign.C.z	at.C.z	auths.C.z	bfs.C.z	cal.C.z	compress.C.z	cp.C.z
      ...
      usemouse.C.z	vc.C.z	vmstat.C.z	wait.C.z	wc.C.z	write.C.z

      Intro.F.z a_out.F.z	acct.F.z	archive.F.z	cpio.F.z	devices.F.z	dialers.F.z
      ...
      stune.F.z	syms.F.z	tar.F.z	term.F.z	x_out.F.z

      80387.HW.z	fd.HW.z scsi.HW.z	serial.HW.z	Intro.M.z	chrtbl.M.z	clone.M.z
      console.M.z	cvtcoff.M.z	error.M.z	environ.M.z	getclk.M.z	init.M.z	math.M.z
      ...
      uucico.ADM.z	uulist.ADM.z	uutry.ADM.z	wall.ADM.z	xts.ADM.z	xtt.ADM.z

      300.C.z	450.C.z	awk.C.z	calendar.C.z	chgrp.C.z	cmp.C.z	col.C.z
      ...
      who.C.z	whodo.C.z	xargs.C.z	yes.C.z

      authcap.F.z	clock.F.z	ar.F.z	default.F.z	dir.F.z	dirent.F.z	langif.F.z	maxuus.F.z
      ...
      utmp.F.z	xbackup.F.z

      Intro.HW.z	audit.HW.z	lp.HW.z	prf.HW.z	boot.HW.z	cdrom.HW.z	cmos.HW.z
      hd.HW.z	machine.HW.z	mouse.HW.z	ramdisk.HW.z	rtc.HW.z	screen.HW.z	tape.HW.z
      xt.HW.z

      coltbl.M.z	getty.M.z	layers.M.z	ld.M.z

      ascii.M.z	cvtomf.M.z	fcntl.M.z	isverify.M.z	jagent.M.z	login.M.z
      ...
      timod.M.z	tz.M.z	tirdwr.M.z	values.M.z	xtproto.M.z
