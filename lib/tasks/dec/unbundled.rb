collectionNamespace 'unbundled' do
  manualNamespace 'Tru64/ACMSxp_3.2A',
  ...
  manualNamespace 'Tru64/BASEstar_Open_Server_3.2',
    vendor_class: Tru64::V4_0f,
  ...
  manualNamespace 'Ultrix/C_1.0/VAX',
  ...
  manualNamespace 'Tru64/C++_6.2',
    ...
    sources: %w[usr/share/doclib/cplusplus/*.htm] do |t|  # TODO html support
      assetsTask %w(*.gif *.ps *.pdf), t[:idir], t[:odir], cut_dirs: 4
      task :all => [:assets]
    end
  manualNamespace 'Tru64/COBOL_2.6',
    vendor_class: Tru64::V4_0f,
    idir: 'dec/du/unbundled/dca260',
    odir: 'DEC/unbundled/Tru64/COBOL_2.6',
    sources: %w[usr/lib/cmplrs/cobol_260]
  manualNamespace 'Tru64/DCE_3.1',
    vendor_class: Tru64::V4_0f,
  ...
  manualNamespace 'Ultrix/DECnet_3.0/VAX',
  ...
  manualNamespace 'Ultrix/DECnet_SNA_1.0',
    vendor_class: Ultrix::V4_2_0,  # REVIEW correct?
    idir: 'dec/ultrix/unbundled/decnetsna_1.0',
    odir: 'DEC/unbundled/Ultrix/DECnet_SNA_1.0',
    sources: %w[usr/man/man1]
  manualNamespace 'Digital_UNIX/DECnet_OSI_4.0C',
  ...
  manualNamespace 'Tru64/DECnet_WAN_Support_3.1',
    vendor_class: Tru64::V4_0f,
  ...
  manualNamespace 'Digital_UNIX/EDI_3.2',
    vendor_class: Digital_UNIX::V4_0d,
  ...
  manualNamespace 'Digital_UNIX/Extended_Math_Library_3.4',
    vendor_class: Digital_UNIX::V4_0d,
    idir: 'dec/du/unbundled/xmd340',
    odir: 'DEC/unbundled/Digital_UNIX/Extended_Math_Library_3.4',
    sources: %w[usr/opt/XMDMAN340/man]
  manualNamespace 'OSF1/F-RJE_1.0',
    vendor_class: OSF1::V3_2c,
    odir: 'DEC/unbundled/OSF1/F-RJE_1.0',
    idir: 'dec/du/unbundled/fjr100', # have to use OSF1 to convert deckanji encoding to something we can cope with
  ...
  manualNamespace 'Digital_UNIX/MAILbus_400_2.0C',
    vendor_class: Digital_UNIX::V4_0d,
  ...
  manualNamespace 'Digital_UNIX/PHIGS_5.1',
    vendor_class: Digital_UNIX::V4_0d,
    idir: 'dec/du/unbundled/pho510',
    odir: 'DEC/unbundled/Digital_UNIX/PHIGS_5.1',
    sources: %w[usr/man/man3]
  manualNamespace 'Digital_UNIX/POLYCENTER_Intrusion_Detector_1.2A',
    vendor_class: Digital_UNIX::V4_0d,
  ...
  manualNamespace 'Digital_UNIX/POLYCENTER_Security_Compliance_Manager_2.5',
    vendor_class: Digital_UNIX::V4_0d,
  ...
  manualNamespace 'OSF1/SNA_3270_Datastream_Programming_Japanese_1.0',
    vendor_class: OSF1::V3_2c,
  ...
  manualNamespace 'OSF1/SNA_Printer_Emulator_Japanese_1.0',
    vendor_class: OSF1::V3_2c,
  ...
  manualNamespace 'OSF1/SNA_RJE_1.0',
    vendor_class: OSF1::V3_2c,
    ...
    odir: 'DEC/unbundled/OSF1/SNA_RJE_1.0',
      ...
      #srcdirs: %w[xlated/usr/opt/*/usr/i18n/usr/share/ja_JP.UTF-8/man/man[138]]
    sources: %w[xlated/usr/opt/*/usr/i18n/usr/share/ja_JP.SJIS/man/man[138]]
  manualNamespace 'OSF1/SNA_DECwindows_3270_Emulator_Japanese_2.1A',
    vendor_class: OSF1::V3_2c,
