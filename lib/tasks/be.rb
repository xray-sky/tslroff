    ...
    manualNamespace 'PR2',
      ...
      sources: %w[
        ...
        beos/documentation/User?s?Guide/HTML/*.html
          ...
          assetsTask %w(*.jp*g *.[gG][iI][fF] *.pdf), t[:idir], t[:odir], cut_dirs: 2
          task :all => [:assets]
        end
    ...
    manualNamespace 'R3',
      ...
      sources: %w[
        ...
        beos/documentation/User?s?Guide
          ...
          assetsTask %w(*.jp*g *.[gG][iI][fF] *.map *.tiff *.eps), t[:idir], t[:odir], cut_dirs: 2, postprocess: :processMacBinary
          task :all => [:assets]
        end
    manualNamespace 'R4',
      ...
      sources: %w[
        ...
        beos/documentation/Virtual_Press_Kit/aboutbe/pressreleases
          ...
          assetsTask %w(*.jp*g *.[gG][iI][fF] *.eps), t[:idir], t[:odir], cut_dirs: 2
          task :all => [:assets]
        end
    manualNamespace 'R4.5',
